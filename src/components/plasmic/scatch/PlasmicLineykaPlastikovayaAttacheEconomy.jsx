...
import sty from "./PlasmicLineykaPlastikovayaAttacheEconomy.module.css"; // plasmic-import: HOE7BqVAPmFF/css
  ...
  return (
    <React.Fragment>
      <div className={projectcss.plasmic_page_wrapper}>
        <div
          data-plasmic-name={"lineyka"}
          data-plasmic-override={overrides.lineyka}
